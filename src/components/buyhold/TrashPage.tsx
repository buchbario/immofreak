      ...
      >
        {modeItems.length > 0 && (
          <div className="px-5 sm:px-7 pt-4">
            <div className="flex items-start gap-3 rounded-[10px] border border-amber-300/70 bg-amber-50 dark:border-amber-500/30 dark:bg-amber-500/10 p-3">
              <AlertTriangle size={15} className="shrink-0 mt-0.5 text-amber-700 dark:text-amber-400" />
